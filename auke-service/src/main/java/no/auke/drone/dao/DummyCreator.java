...
public class DummyCreator {
    ...
    public DummyCreator() {
        ...
        list.add(createPositionUnit(UUID.randomUUID().toString(), 1413835537, hcm.getLat(), hcm.getLon(), 5, 0.0));
        list.add(createPositionUnit(UUID.randomUUID().toString(), 1413835537, 10.82309, 106.62966, 5, 0.0));
        for (int i = 1; i <= 50; i++) {
          Location rd = generateRandomLoc(hcm, 100000);
          list.add(createPositionUnit(UUID.randomUUID().toString(), 1413835537, rd.getLat(), rd.getLon(), 5, 0.0));
      }
    }
