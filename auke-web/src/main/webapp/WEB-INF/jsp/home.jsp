...
<html>
  ...
  <body>
    <div class="info" style="font-weight: bold; font-size: 20pt;"> Zoom Factory: <span style="color: red" id="resultZoom"></span> - Number drone in current view is: <span style="color: red" id="numberDrone"></span>  <input type="button" onclick="reloadMarkers()" value="reload all drones in current view" /> </div>
